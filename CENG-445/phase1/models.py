...
class User:
    ...
    def __del__(self):
        return f"User {self.username} with username: {self.username} has been deleted!"
        ...
        if self.player_list.index(player) != self.turn_:
            ...
            if player.enough_is_enough == USER_ACTION_STATUS_MUST_PICK_AND_TELEPORT:
                ...
                if not right_command:
                    return "You have to pick and teleport. other commands are not available!"
                ...
                if command == COMMAND_CHOICES[COMMAND_ROLL][1]:
                    return "You have already used Roll command!"
            ...
            if command == COMMAND_CHOICES[COMMAND_PASS][1]:
                ...
                if player.enough_is_enough == USER_ACTION_STATUS_MUST_ROLL:
                    return "You have to roll the dice first!"
                result_text = f"End of turn for {player.user.username}"
                ...
                if player.balance >= self.jailbail:
                    ...
                    result_text = f"Paid ${self.jailbail}. You're out of jail!"
                ...
                if player.board_position.type == CELL_TYPE_CHOICES[CELL_TYPE_JAIL][1]:
                    ...
                    if pulled_card == CHANCE_CHOICES[CHANCE_JAIL_FREE][1]:
                        ...
                        self.put_card_back(pulled_card)
                        return "You picked teleport card. Pick a property and teleport!"
                    elif (
                        ...
                        player.chance_cards_owned.append(pulled_card)
                        return f"You picked a chance card ({pulled_card})!"
                elif (
                    ...
                    if (
                        ...
                        and player.board_position.owner.user.username
                        ...
                        result_text = f"You have paid rent to {player.board_position.owner.user.username}"
                    else:
                        return f"You are on the property named {player.board_position.name}"
                elif (
                    player.board_position.type
                    ...
                    return "You are now on the teleport cell. You have to pick a property to teleport!"
                ...
                if cell.type == CELL_TYPE_CHOICES[CELL_TYPE_PROPERTY][1]:
                    ...
                    if player.balance >= property_price:
                        ...
                        player.enough_is_enough = USER_ACTION_STATUS_MUST_PASS
                        result_text = f"You bought property named '{cell.name}'"
                    else:
                ...
                if (
                    ...
                    result_text = (
                        f"You have upgraded property with name {player.picked_cell}"
                    )
                elif (
                    player.picked_cell
                    ...
                    while amount > 0:
                        ...
                        upgraded_cell = upgraded_cell.next_cell
                    player.picked_cell = None
                    result_text = f"You have upgraded all properties with color {color}"
                elif (
                    player.board_position.type
                    == CELL_TYPE_CHOICES[CELL_TYPE_PROPERTY][1]
                ):
                    ...
                    if cell.level == 4:
                        ...
                        return "You don't have enough funds to upgrade this property!"
                ...
                if (
                    ...
                    player.picked_cell = None
                    result_text = (
                        f"You have downgraded all properties with color {color}!"
                    )
                ...
                if picked_location:
                    for cll in self.cells:
                        if (
                            ...
                            return (
                                f"You have picked the property named '{extra_field}'!"
                            )
                    return f"Could not find property with name {extra_field}!"
                else:
                    return "You cannot pick cell types other than properties!"
                ...
                if player.picked_cell is None:
                    return "You should pick a cell to teleport first!"
                elif (
                    player.enough_is_enough == USER_ACTION_STATUS_MUST_PICK_AND_TELEPORT
                ):
                    while True:
                    ...
                    player.enough_is_enough = USER_ACTION_STATUS_CAN_PASS
                    return (
                        f"You teleported onto a property named '{player.picked_cell}'"
                    )
                else:
                    return "You don't have a teleport card!"
